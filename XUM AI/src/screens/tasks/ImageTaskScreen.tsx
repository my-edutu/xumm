...
export const ImageTaskScreen: React.FC<ImageTaskScreenProps> = ({ onNavigate }) => {
    ...
    const {
        ...
        submitTask,
        skipPrompt
    } = useTask({ taskType: 'image', tasksPerSession: 5 });
            ...
            <ScrollView style={styles.flex1} contentContainerStyle={styles.scrollContent}>
                ...
                {capturedUri ? (
                    <View style={{ marginTop: 24 }}>
                        ...
                        <View style={{ marginTop: 24 }}>
                            <Text style={{ color: theme.text, fontWeight: '600', marginBottom: 12 }}>Add Description (Optional)</Text>
                            <TextInput
                            ...
                            >
                                {isSubmitting ? (
                                    ...
                                    <Text style={{ color: '#fff', fontWeight: '700', fontSize: 16 }}>SUBMIT PHOTO</Text>
                                )}
                            </TouchableOpacity>
                        </View>
                    </View>
